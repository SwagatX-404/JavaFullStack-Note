...
- If we need to return a result or an object from a method 
...
- For example 
	...
	6. For returning multiple float values as a group 
...
- For example:
		...
		- In the above method 
			1. in the method declaration, the 'int' is the return type specifies 
				   this method returns one int value 
		
			2. In the method body, the keyboard 'return' 
...
- The 'return;' is meant for terminating the method logic execution and
  return control to the calling method without value. 
...
- The 'return value/object;' is meant for terminating the method logic execution 
  and return control to the calling method with value or object.
